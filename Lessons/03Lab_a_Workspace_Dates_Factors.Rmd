...
#Build a function to fix year that is more general than the one discussed in the lesson. d is the date
#cutoff will be another date object. this will get rid of the year i think 
d <- ymd("55-feb-3")
cutoff <- 24 
...
#Alternative 1: L is because if you assign nay number to a variable it will treat it like a floating point number like a number with a decimal point, L is short for a long integer 
...
#Convert date column to date object: hms is hours, minutes, seconds 
...
#Compute the day of the week each sample was collected. dow is days of the week 
