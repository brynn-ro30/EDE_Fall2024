...
```{r Creating vectors}
# Vectors ----
vector1 <- c(1,2,5.3,6,-2,4) # Vector type: Numeric #little c just means combine all these values together 
vector1
class(vector1)
...
#
max(vector1) #maxiumum vector of vector 1 
...
#
toupper(vector2) #changing lower case to uppercase 

#
!vector3 #! this denies an object and gives you the opposite 
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) #organizes matrices be coloumn 
matrix1
...
matrix2 <- matrix(1:20, 
                  nrow = 5, 
                  ncol = 4, 
                  byrow = TRUE) #organizes matrices by row 
matrix2
...
matrix3 <- matrix(
  ...
  nrow = 5, 
  ncol = 4, 
  byrow = TRUE, # return after comma continues the line, dinames:defines names 
  dimnames = list(
...
matrix1[4, 1] #row 4 coloumn 1 

matrix1[4,  ] #all of row 4 

matrix1[ , 3] #just coloumn 3

matrix1[c(12, 14)] #specify you want this both 

matrix1[c(12:14)] #or specify ranges 
...
#assess the elements, i want to get the value of the fourth element 
list1[[4]] = 44
```
