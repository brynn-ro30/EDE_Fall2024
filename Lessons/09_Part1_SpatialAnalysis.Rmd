...
#install.packages('sf')
library(sf)
#install.packages('leaflet') cool map
library(leaflet)
#install.packages('mapview') cool map
...
#Convert to a spatial dataframe, by combing lat and long
EPAair.sf <- EPAair.sites %>% 
  st_as_sf( 
    coords = c('mean_Lng','mean_Lat'), #long is x lat is y
    crs=4326
    )
...
#Transform the datasets to use UTM 17 N, WGS84 a different coordinate system 
