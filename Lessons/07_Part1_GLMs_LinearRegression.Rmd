...
#base irradiance (lm) based off peter paul data set 
...
irradiancebydepth <- 
  ...
  ylim(0, 2000) + #shows limit on y value to 2000 to get rid of outlier 
  geom_point() 
...
PeterPaul.chem.nutrients <- filter(PeterPaul.chem.nutrients, 
                                   irradianceWater != 0 & irradianceWater < 5000) #get rid of 0's get rid of outliers above 5000 
...
plot(TPregression)
par(mfrow = c(1,1))
#want red line to be flat need to improve linear regression 
