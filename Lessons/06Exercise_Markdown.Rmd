...
knitr::opts_chunk$set(include = FALSE) #both of these get rid of code on final
#Load packages
...
The raw dataset has `r nrow(nutreint_data_raw)` rows and `r ncol(nutrient_data_raw)`columns. 
## Wrangle the data
...
nutrient_data_tn #nah not good enough 
