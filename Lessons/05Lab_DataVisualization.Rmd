...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    x=0,
    y=0.025,
    label=expression(paste("Mean is ", mu,",", R^{2},'=0.6')) #this will label the graph 
    )
...
Plot_Lake0bs_perMonth <-
  ggplot(PeterPaul.chem.nutrients)+
  geom_bar(aes(x=month))
print(Plot_Lake0bs_perMonth)
...
PeterPaul.chem.nutrients %>% 
  ...
  #using color inside aes is
#color coding plot inside that plot, when use it outside, just chasing color of specfic layer 
