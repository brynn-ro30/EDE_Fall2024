...
> Answer:
Population and then mortality EXPAND 
...
> Answer:
Honey Bee, Paraitic Wasp, Buff Tailed Bumblebee, Carnolian Honey Bee, Bumble Bee, Italian Honeybee 
EXPAND
...
> Answer: It is a factor, non-number characters in column, is not a full numeric answer either, seems to be a calculation 
...
The unique function will show the repeated values only once wheras summary whill show all of the values even if they are repeated. 
