...
```{r echo=FALSE, fig.align="left", fig.cap="Ozone Levels in 2018", fig.height=3, fig.width=8, warning=FALSE}
summary_ozone2018<-
  epa_data %>% 
  filter(Year == "2018") 
...
```{r echo=FALSE, fig.align="left", fig.cap="Ozone Levels in 2019", fig.height=3, fig.width=8, warning=FALSE}
summary_ozone2019<-
  epa_data %>% 
  filter(Year == "2019") 
